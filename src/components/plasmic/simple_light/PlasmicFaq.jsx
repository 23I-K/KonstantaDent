...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: BHmxGDrMbzr5z/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__hvdy)}
      >
        <div className={classNames(defaultcss.all, sty.box__cC7Ma)}>
          <div className={classNames(defaultcss.all, sty.box___3Zu0)}>
            <p.PlasmicSlot
