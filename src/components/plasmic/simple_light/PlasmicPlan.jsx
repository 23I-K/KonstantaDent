...
import BaseCard from "../../BaseCard"; // plasmic-import: RaxUROeLiIb7I/component
import Bullet from "../../Bullet"; // plasmic-import: bqyFOuhIkq3X7/component
import LinkButton from "../../LinkButton"; // plasmic-import: Dumym2P0mPVt/component
import "@plasmicapp/react-web/lib/plasmic.css";
import * as defaultcss from "../plasmic__default_style.module.css"; // plasmic-import: global/defaultcss
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: LZGM4Yp_pXVWY/css
...
function PlasmicPlan__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__sAxew)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__poiBk)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__m4JR)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__u9PDx)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__uaYm4)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__bSts)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box___42Lmj)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
