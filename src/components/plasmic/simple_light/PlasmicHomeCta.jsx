...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: u8N8ig3kp_va/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: Ajh7QXHC3-YEg/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__rmWbl)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___9CvMg)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__oxMhm)}>
          <SphereIcon
