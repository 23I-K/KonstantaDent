...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: kADghGVlNdQS/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__jocGq)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xn0Lx)}
        >
          <div className={classNames(defaultcss.all, sty.box__iwYL)}>
            <div
