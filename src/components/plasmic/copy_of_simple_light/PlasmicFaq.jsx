...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: lo9LNs-Sx-Z9/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__pRjxE)}
      >
        <div className={classNames(defaultcss.all, sty.box__jdIdi)}>
          <div className={classNames(defaultcss.all, sty.box__jvzPm)}>
            <p.PlasmicSlot
