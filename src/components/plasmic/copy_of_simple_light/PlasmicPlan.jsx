...
import BaseCard from "../../BaseCard"; // plasmic-import: YnCZvKzHuPe-/component
import Bullet from "../../Bullet"; // plasmic-import: AETPdr_Y4_DA/component
import LinkButton from "../../LinkButton"; // plasmic-import: MxOTJDJLWhAH/component
import "@plasmicapp/react-web/lib/plasmic.css";
import * as defaultcss from "../plasmic__default_style.module.css"; // plasmic-import: global/defaultcss
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: k5aE16whrDFf/css
...
function PlasmicPlan__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___8JX)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__dvYt6)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__fl5K0)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__xiSQt)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__kgan)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__gp2Ax)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box__sk9I9)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
